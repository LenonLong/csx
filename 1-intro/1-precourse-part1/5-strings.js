/*
Challenge: Strings
Strings are a data type in JavaScript. In short, they are bits of text written inside of quotation marks. 
You can use either single quotes ('), double quotes ("), or backticks (`) as quotation marks to wrap a string, 
as long as the opening and closing symbols match. They are particularly useful for any data or value that can be represented as plain text.
...
// ADD CODE BELOW
const mySingleString = 'hi';
const myDoubleString = "i'm a double string"
const myBackString = `holla backtick`
