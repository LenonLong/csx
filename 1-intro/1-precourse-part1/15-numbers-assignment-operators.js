...
num += 10
console.log(num) // => 15
Here, we have the syntax of num += 10. This is the same thing as typing num = num + 10. By using the addition 
assignment operator (+=) we are able to add 10 to num similarly to how we did above with the incrementor/decrementor.
