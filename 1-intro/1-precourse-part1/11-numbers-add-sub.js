...
Another type of value that can be stored in a variable is a number. Pay close attention to the fact that the number is not wrapped in quotes. 
Keep in mind that if a value is wrapped in quotes, it becomes a string.
