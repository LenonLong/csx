/*
Challenge: Booleans
Boolean (BOO-lee-uhn) is another data type in JavaScript. JavaScript boolean values can be either true or false. 
...
In the example above, we're using the === operator (we'll talk about this in more detail in the next challenge) to compare numToCheck 
with 10 and determine if they are equal. If they are equal, both in value and data type, then JavaScript will log true. Otherwise, it will log false.
